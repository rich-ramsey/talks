...
- **Aim:** Provide the lab with a general context for thinking about data analysis and statistics.

- **Disclaimer:** I'm not a statistician. I'm not a statistician. I'm not a statistician...
:::

::: {.column width="40%"}
![](images/confused.png){width=200px}\
![](images/analysis.png){width=200px}
:::
::::
...
::: {.g-col-12 style="font-size: 0.7em;" .incremental}
...
-   Take advantage of partial pooling / shrinkage.
:::
